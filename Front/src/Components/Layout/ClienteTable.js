...
const ClienteTable = ({
  ...
  return (
    <Table>
      <TableHead>
        <TableRow>
          {["Código", "Razón Social", "Nombre Fantasía", "RUT", "Giro", "Teléfono", "Email", "Estado", "Acciones"].map((header) => (
      ...
      <TableBody>
        {stableSort(clientes, comparator).map((cliente) => (
          <TableRow key={cliente.ID_CLIENTE}>
            ...
            <TableCell>{cliente.TELEFONO_FIJO || cliente.TELEFONO_CELULAR}</TableCell>
